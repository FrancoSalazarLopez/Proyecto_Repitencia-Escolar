...
![Dashboard Interactivo](img/dashboard_final.jpg)
...
* **Power BI:** Diseño de un tablero interactivo con KPIs de inversión por alumno y tasas de repitencia por zona.
* **Python:** Análisis exploratorio (EDA) utilizando `Seaborn` para validar las tendencias de matrícula y unidades de servicio.

## 📂 Estructura del Proyecto
* `/data`: Datasets originales y procesados.
* `/scripts_sql`: Modelado de tablas de hechos y dimensiones.
* `/notebooks`: Limpieza inicial y gráficos en Python.
